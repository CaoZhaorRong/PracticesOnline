...
public class UserCookies {
    ...
    public static final UserCookies INSTANCE = new UserCookies();
    ...
    private UserCookies() {
        ...
        spOption = AppUtils.getContext()
                .getSharedPreferences("question_radioButton", Context.MODE_PRIVATE);
    }
    ...
    public void UpReadCount(String questionId) {
