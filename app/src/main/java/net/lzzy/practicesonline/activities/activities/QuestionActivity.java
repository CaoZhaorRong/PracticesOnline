...
import net.lzzy.practicesonline.activities.models.views.PracticeResult;
...
public class QuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserCookies.getInstance().UpReadCount(questions.get(pos).getId().toString());
    }
    ...
    private void setListeners() {
        pager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                UserCookies.getInstance().UpReadCount(questions.get(position).getId().toString());
            }
