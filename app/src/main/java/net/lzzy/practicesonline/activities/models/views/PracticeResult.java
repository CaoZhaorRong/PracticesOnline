...
public class PracticeResult {
    ...
    public JSONObject toJson() throws JSONException {
        ...
        json.put(ApiConstants.JSON_RESULT_PHONE_NO, info);
        json.put(ApiConstants.JSON_RESULT_SCRORE_RATIO,
                new DecimalFormat("#.00").format(getRatio()));
        json.put(ApiConstants.JSON_RESULT_WRONG_QUESTION_IDS, getWrongOrders());
        return json;
    }
}
